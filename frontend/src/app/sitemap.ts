...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    try {
        ...
        const staticPages = [
            ...
            { path: "filter", priority: 0.8, changeFrequency: "daily" as const },
            ...
            { path: "delivery-shipping", priority: 0.6, changeFrequency: "monthly" as const },
            { path: "privacy-policy", priority: 0.5, changeFrequency: "yearly" as const },
            { path: "return-refund-policy", priority: 0.5, changeFrequency: "yearly" as const },
            { path: "terms-conditions", priority: 0.5, changeFrequency: "yearly" as const },
        ]
        ...
        // Add product pages - collect all products across all countries
        for (const countryCode of countryCodes) {
            try {
                let pageParam = 1
                const limit = 100
